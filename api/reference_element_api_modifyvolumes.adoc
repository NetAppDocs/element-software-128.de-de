...
summary: Mit der Methode ModifyVolumes können Sie bis zu 500 vorhandene Volumes gleichzeitig konfigurieren.  Die Änderungen erfolgen sofort.  Wenn ModifyVolumes bei einem der angegebenen Volumes fehlschlägt, wird keines der angegebenen Volumes geändert. 
---
= ModifyVolumes
:allow-uri-read: 
:icons: font
