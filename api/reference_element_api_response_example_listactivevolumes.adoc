...
summary: Die Methode ListActiveVolumes gibt eine Antwort zurück, die dem folgenden Beispiel ähnelt. 
---
= ListActiveVolumes
:allow-uri-read: 
:icons: font
...
[role="lead"]
Der `ListActiveVolumes` Die Methode gibt eine Antwort zurück, die dem folgenden Beispiel ähnelt.
