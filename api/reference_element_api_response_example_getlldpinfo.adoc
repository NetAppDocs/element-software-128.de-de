...
summary: Die GetLldpInfo-Methode gibt eine Antwort zurück, die dem folgenden Beispiel ähnelt. 
---
= GetLldpInfo
:allow-uri-read: 
:icons: font
...
[role="lead"]
Der `GetLldpInfo` Die Methode gibt eine Antwort zurück, die dem folgenden Beispiel ähnelt.
