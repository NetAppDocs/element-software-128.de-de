...
summary: Die GetNodeHardwareInfo-Methode für Fibre Channel-Knoten gibt eine Antwort zurück, die dem folgenden Beispiel ähnelt. 
---
= GetNodeHardwareInfo (Ausgabe für Fibre-Channel-Knoten)
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Der `GetNodeHardwareInfo` Die Methode für Fibre Channel-Knoten liefert eine Antwort, die dem folgenden Beispiel ähnelt.
