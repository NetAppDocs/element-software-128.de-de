...
summary: Mit der GetAPI-Methode erhalten Sie eine Liste aller API-Methoden und unterstützten API-Endpunkte, die im System verwendet werden können. 
---
= GetAPI
:allow-uri-read: 
:icons: font
...
[role="lead"]
Sie können die `GetAPI` Methode zum Abrufen einer Liste aller API-Methoden und unterstützten API-Endpunkte, die im System verwendet werden können.
...
<Version>
 a| 
Eine Liste aller unterstützten API-Methoden für diese Softwareversion, wobei <Version> die aktuelle Softwareversion ist, auf der dieses System läuft.
 a| 
Zeichenketten-Array
...
aktuelle Version
 a| 
Die aktuelle Version der Speichercluster-Software.
 a| 
Schnur
