...
summary: Die GetNetworkConfig-Methode gibt eine Antwort zurück, die dem folgenden Beispiel ähnelt. 
---
= GetNetworkConfig
:allow-uri-read: 
:icons: font
...
[role="lead"]
Der `GetNetworkConfig` Die Methode gibt eine Antwort zurück, die dem folgenden Beispiel ähnelt.
