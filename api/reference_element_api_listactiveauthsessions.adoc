...
summary: Mit der Methode ListActiveAuthSessions können Sie alle aktiven authentifizierten Sitzungen auflisten.  Nur Benutzer mit Administratorrechten können diese Methode aufrufen. 
---
...
[role="lead"]
Sie können die `ListActiveAuthSessions` Methode zum Auflisten aller aktiven authentifizierten Sitzungen.  Nur Benutzer mit Administratorrechten können diese Methode aufrufen.
