...
NOTE: Diese Methode ermöglicht keine Softwareverschlüsselung im Ruhezustand.  Dies kann nur mit Hilfe des/derlink:../api/reference_element_api_createcluster.html["Methode zum Erstellen von Clustern"^] mit `enableSoftwareEncryptionAtRest` eingestellt auf `true` Die
