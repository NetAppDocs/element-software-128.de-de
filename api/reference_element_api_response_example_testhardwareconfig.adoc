...
summary: Die Methode TestHardwareConfig gibt eine Antwort zurück, die dem folgenden Beispiel ähnelt. 
---
= TestHardwareConfig
:allow-uri-read: 
:icons: font
...
[role="lead"]
Der `TestHardwareConfig` Die Methode gibt eine Antwort zurück, die dem folgenden Beispiel ähnelt.
