...
summary: Die GetNvramInfo-Methode gibt eine Antwort zurück, die dem folgenden Beispiel ähnelt. 
---
= GetNvramInfo
:allow-uri-read: 
:icons: font
...
[role="lead"]
Der `GetNvramInfo` Die Methode gibt eine Antwort zurück, die dem folgenden Beispiel ähnelt.
