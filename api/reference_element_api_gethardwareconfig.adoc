...
summary: Mit der Methode GetHardwareConfig können Sie die Hardwarekonfigurationsinformationen für einen Knoten abrufen. 
---
= GetHardwareConfig
:allow-uri-read: 
:icons: font
...
[role="lead"]
Sie können die `GetHardwareConfig` Methode zum Abrufen der Hardwarekonfigurationsinformationen für einen Knoten.  Diese Konfigurationsdaten sind für den internen Gebrauch bestimmt.  Um eine aussagekräftigere Bestandsaufnahme der Hardwarekomponenten eines Live-Systems zu erhalten, verwenden Sie die `GetHardwareInfo` stattdessen diese Methode.
...
| hardwareConfig | Liste der Hardwareinformationen und aktuellen Einstellungen. | JSON-Objekt 
|===
