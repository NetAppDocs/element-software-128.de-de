...
summary: Die GetConfig-Methode gibt eine Antwort zurück, die dem folgenden Beispiel ähnelt.  Aufgrund der Länge enthält die Antwort nur Informationen für einen Knoten des Clusters. 
---
= GetConfig
:allow-uri-read: 
:icons: font
...
[role="lead"]
Der `GetConfig` Die Methode gibt eine Antwort zurück, die dem folgenden Beispiel ähnelt.  Aufgrund der Länge enthält die Antwort nur Informationen für einen Knoten des Clusters.
