...
summary: Mit der ListServices-Methode können Sie Informationen zu Diensten für Knoten, Laufwerke, aktuelle Software und andere Dienste, die auf dem Cluster ausgeführt werden, auflisten. 
---
= ListServices
:allow-uri-read: 
:icons: font
...
[role="lead"]
Sie können die `ListServices` Methode zum Auflisten von Dienstinformationen für Knoten, Laufwerke, aktuelle Software und andere Dienste, die auf dem Cluster ausgeführt werden.
...
Dienstleistungen
 a| 
Dienste, die auf Laufwerken und Knoten ausgeführt werden.
 a| 
JSON-Objekt
