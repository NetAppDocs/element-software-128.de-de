...
summary: Mit der Methode GetSSLCertificate können Sie das SSL-Zertifikat abrufen, das aktuell auf den Speicherknoten des Clusters aktiv ist. 
---
...
[role="lead"]
Sie können die `GetSSLCertificate` Methode zum Abrufen des SSL-Zertifikats, das aktuell auf den Speicherknoten des Clusters aktiv ist.
...
Zertifikat
 a| 
Der vollständige PEM-kodierte Text des Zertifikats.
 a| 
Schnur
...
Details
 a| 
Die dekodierten Informationen des Zertifikats.
 a| 
JSON-Objekt
