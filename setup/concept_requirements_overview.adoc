...
[role="lead"]
Bevor Sie beginnen, sollten Sie die Voraussetzungen für die Bereitstellung der NetApp Element -Software überprüfen, einschließlich der Netzwerk- und Portanforderungen.
