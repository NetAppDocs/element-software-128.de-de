...
summary: Das System meldet einen Fehler oder einen Zustand, der von Interesse sein könnte, indem es einen Fehlercode generiert, der auf der Seite „Warnungen“ angezeigt wird.  Mithilfe dieser Codes können Sie feststellen, welche Systemkomponente die Warnung ausgelöst hat und warum die Warnung generiert wurde. 
---
= Cluster-Fehlercodes
:allow-uri-read: 
:icons: font
